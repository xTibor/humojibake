...
#[rustfmt::skip]
pub const ENCODING_ISO_646_HU: EncodingDefinition = EncodingDefinition {
    encoding_table: [
        ...
        '\u{0020}', '\u{0021}', '\u{0022}', '\u{0023}', '\u{00A4}', '\u{0025}', '\u{0026}', '\u{0027}', // 0x20 - 0x27
        ...
        '\u{0050}', '\u{0051}', '\u{0052}', '\u{0053}', '\u{0054}', '\u{0055}', '\u{0056}', '\u{0045}', // 0x50 - 0x57
        ...
        '\u{0070}', '\u{0071}', '\u{0072}', '\u{0073}', '\u{0074}', '\u{0075}', '\u{0076}', '\u{0065}', // 0x70 - 0x77
        '\u{0078}', '\u{0079}', '\u{007A}', '\u{00E9}', '\u{00F6}', '\u{00FC}', '\u{20DD}', '\u{0000}', // 0x78 - 0x7F

        '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', // 0x80 - 0x87
        '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', // 0x88 - 0x8F
        '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', // 0x90 - 0x97
        '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', '\u{0000}', // 0x98 - 0x9F
