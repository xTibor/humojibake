...
#[rustfmt::skip]
pub const ENCODING_ENTERPRISE_PLUS_HUN: EncodingDefinition = EncodingDefinition {
    encoding_table: [
        ...
        '\u{0078}', '\u{0079}', '\u{007A}', '\u{007B}', '\u{007C}', '\u{007D}', '\u{007E}', '\u{0192}', // 0x78 - 0x7F

        '\u{00C1}', '\u{00C9}', '\u{00CD}', '\u{00D3}', '\u{00D6}', '\u{0150}', '\u{00DA}', '\u{00DC}', // 0x80 - 0x87
        '\u{0170}', '\u{250C}', '\u{2514}', '\u{2502}', '\u{251C}', '\u{252C}', '\u{2588}', '\u{253C}', // 0x88 - 0x8F
        '\u{00E1}', '\u{00E9}', '\u{00ED}', '\u{00F3}', '\u{00F6}', '\u{0151}', '\u{00FA}', '\u{00FC}', // 0x90 - 0x97
        '\u{0171}', '\u{2510}', '\u{2518}', '\u{2500}', '\u{2524}', '\u{2534}', '\u{2190}', '\u{0000}', // 0x98 - 0x9F
